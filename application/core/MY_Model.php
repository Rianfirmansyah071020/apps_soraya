...
class MY_Model extends CI_Model
{
    ...
    public function joinAlt3($table, $table2, $type = 'left')
    {
        $this->db->join($table, "$table.id = $table2.id_$table");
        return $this;
    }

    public function joinAltPenggunting($table_1, $table_2, $type = 'left')
    {
        $this->db->join($table_2, "$table_1.id = $table_2.id_$table_1");
        return $this;
    }
