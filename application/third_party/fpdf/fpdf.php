...
function Header()
{
	...
	// Logo
        $this->Image('https://www.sorayabedsheet.id/assets/images/logos/logo.png', 10, 6, 25);
        // Arial bold 15
        $this->SetFont('Courier', 'B', 16);
        // Move to the right
        $this->Cell(80);
        // Title
        $this->Cell(120, 6, 'PT.SORAYA BERJAYA INDONESIA', 0, 1, 'C');
        
        $this->SetFont('Courier', '', 11);
        // Sub Title
        $this->Cell(280, 6, 'Jln. Palangkaraya No.7, Nanggalo, Kota Padang, Sumatera Barat', 'B', 0, 'C');
        // Line break
        $this->Ln(10);
}
