            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        ...
                        <span style="font-size: 12px; color: #b1b1b1; margin-top: 10px;">detail dari progress <?= $id; ?></span> <br>
                        <br>
                    ...
                    <div class="body" data-id="<?= $this->session->flashdata('id_insert'); ?>">
                        ...
                        <div class="row bg-custom">
                            ...
                            <div class="col-xs-3">
                                <p>Tgl Realisasi : <?= date_format(new DateTime($data_progress->tanggal_rencana), "D / d M Y"); ?></p>
                            </div>
                            <div class="col-xs-3">
